...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-11-2022 a las 01:03:40
...
(18, 'estatus de tareas ', 'si esta pendiente en curso o realizada.', '2022-11-28 23:59:34', 7),
(19, 'enviar correo', 'cuando se registre una tarea y cuando se registre el usuario.', '2022-11-29 00:00:40', 7);
...
(2, 'gleyvert', 'lagos', 'gleyvertlagos@gmail.com', 30, '$2y$10$He0hBB1xGdGTs795QsEkHuY2ZHfCm5WT3CmaB1ZUAVtE3yAx9Er.u', 0, 0),
(3, 'gleyvert', 'lagos', 'gleyvertlagos@gmail.com', 30, '$2y$10$jZdPXAJOtQFy.xre/b3ImO9Hr/vhKLHOM6zn7OnpMO4KP.xoYkCpu', 0, 0),
(4, 'gleyvert', 'lagos', 'gleyvertlagos@gmail.com', 30, '$2y$10$NXShRPN2jjQ.AliebNn5HeSLPJN0fKwbTjTkLE98MgB4wv9xj1A3a', 0, 0),
