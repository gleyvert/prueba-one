...
if(!empty($_POST['email']) && !empty($_POST['password'])){
	$sql = "INSERT INTO usuarios (nombre,apellido,email,edad,password) VALUES (:nombre, :apellido, :email, :edad,:password)";
	...
	if($stmt->execute()){
		...
		$message2='Lo sentimos no se pudo crear el usuario';
	}
}
                            ...
                            <?php if(isset($_SESSION['message']) && $_SESSION['message'] != '') {
                                ...
                                <div class="card card-body bg-success p-2 bg-opacity-50" >
                                    <form action="guardar_usuario.php" method="POST">
                                        ...
                                        <div class="form-group mt-2">
                                            <input type="emai" required name="email" class="form-control" placeholder="Ingrese el email">
                                        </div>
                                        <div class="form-group mt-2">
